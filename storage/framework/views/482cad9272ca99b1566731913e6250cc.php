    ...
    <?php $__env->startSection('content'); ?>
        ...
        <form action="<?php echo e(route('blogs.update',['blog'=>$blog->id])); ?>" method="POST"
            ...
            <div class="my-3">
                ...
                <input type="text" id="name" name="title" class="w-full border rounded-md focus:outline-none focus:bg-[bisque] py-2 px-3" value="<?php echo e(old('title', $blog->title)); ?>" required/>
            </div>
            ...
            <div class="my-3">
                ...
                <textarea name="body" id="body" rows="10" style="resize: none" class="w-full border rounded-md focus:outline-none focus:bg-[bisque] py-2 px-3"><?php echo e(old('body', $blog->body)); ?></textarea>
            </div>
            ...
            <div class="w-full flex gap-x-5">
                ...
                <div class="w-1/2 my-3">
                    ...
                    <input type="text" id="intro" name="intro" class="w-full border rounded-md focus:outline-none focus:bg-[bisque] py-2 px-3" value="<?php echo e(old('intro', $blog->intro)); ?>" required/>
                </div>
                ...
                <div class="w-1/2 my-3">
                    ...
                    <select name="category_id" id="category" class="w-full border rounded-md focus:outline-none focus:bg-[bisque] py-2 px-3">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->id); ?>" <?php if(old('category_id', $blog->category_id) == $category->id): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
...
<?php echo $__env->make('layouts/frontend.adminindex', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\team-project\resources\views/blog/edit.blade.php ENDPATH**/ ?>