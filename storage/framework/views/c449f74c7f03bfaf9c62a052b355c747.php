	...
	<div class="topbars">
		...
		<div class="left-bar">
			...
			<div class="logo">
				<a href="<?php echo e(route('dashboards.index')); ?>" class="flex items-center">
					<span class="icon">
		...
		<div class="right-bar">
			...
			<div class="profile">
				<div class="profile-img topmenu">
					<img src="<?php echo e(asset('/assets/img/profile.avif')); ?>" />
					<span><?php echo e($userdata['name']); ?> <i class="fa-solid fa-angle-down"></i></span>
				</div>
				<ul class="profile-content topsub">

					<li><a href="#"><i class="fa-solid fa-user"></i> Profile</a></li>
					<li><a href="#"><i class="fa-solid fa-wallet"></i> My Wallet</a></li>
					<li><a href="<?php echo e(route('blogs.index')); ?>"><i class="fa-solid fa-rotate"></i> Switch to FE</a></li>
...
<?php /**PATH D:\team-project\resources\views/layouts/backend/dashboardnav.blade.php ENDPATH**/ ?>