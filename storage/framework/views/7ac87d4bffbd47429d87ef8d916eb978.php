        ...
        <div class="h-full flex justify-between items-center">
            <div class="flex items-center space-x-10">
                ...
                <div class="flex justify-center items-center space-x-2">
                 <a href="<?php echo e(route('blogs.index')); ?>" class="flex justify-center items-center cursor-pointer">
                    ...
                    <li class="relative cursor-pointer" onclick="document.getElementById('dropdown').classList.toggle('hidden')">
                        ...
                        <div id="dropdown" class="capitalize mt-4 absolute right-0 hidden">
                            <ul class="min-w-36 bg-gray-200">
                                ...
                                <li><a href="<?php echo e(route('dashboards.index')); ?>" class="w-full text-[16px] text-nowrap inline-block hover:bg-gray-300 p-4"><i class="fas fa-sync-alt me-1"></i> Switch to dashboard</a></li>
                                <?php endif; ?>
                                ...
                                <li><a href="javascript:void(0);" class="w-full text-[18px] text-red-600 font-bold border-t-2 inline-block bg-gray-300 p-4 dropdown-item"   onclick="event.preventDefault(); document.getElementById('logoutform').submit()"><i class="fas fa-power-off me-1"></i> Logout</a>
                                    <form id="logoutform" action="<?php echo e(route('logout')); ?>" method="POST"><?php echo csrf_field(); ?></form></li>
...
<?php /**PATH D:\team-project\resources\views/components/navbar.blade.php ENDPATH**/ ?>